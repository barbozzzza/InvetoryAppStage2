...
public class ProductProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case PRODUCT_ID:
                ...
                // This will perform a query on the products table where the _id equals # to return a
    ...
    private Uri insertBook(Uri uri, ContentValues values) {
        ...
        // Check that price is positive and not null
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(ProductEntry.COLUMN_SUPPLIER_TEL)) {
            // Check that the Supplier name is not null
            String supplierTel = values.getAsString(ProductEntry.COLUMN_SUPPLIER_TEL);
            if (supplierTel == null) {
                throw new IllegalArgumentException();
            }
        }
